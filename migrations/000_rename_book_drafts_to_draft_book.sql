-- Migration: Rename book_drafts table to draft_books
-- Description: Renames the existing book_drafts table and all its indexes to use the new draft_books naming convention
-- Created: 2025-10-19
-- IMPORTANT: Run this migration BEFORE running other migrations if you have an existing book_drafts table

-- Rename the main table
ALTER TABLE IF EXISTS book_drafts RENAME TO draft_books;
...
-- The foreign keys in draft_chapters and draft_questions will now reference draft_books(id)
