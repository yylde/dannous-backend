-- Migration: Add book drafts tracking system
...
CREATE INDEX IF NOT EXISTS idx_book_drafts_gutenberg_id ON book_drafts(gutenberg_id);
CREATE INDEX IF NOT EXISTS idx_book_drafts_is_completed ON book_drafts(is_completed);
